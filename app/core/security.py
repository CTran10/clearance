...
# iss (issuer) + aud (audience) = "who minted this token and who's it FOR". adding these so a token i made
# for service A can't be replayed against service B. before this i was only checking the signature, which means
# any valid token i ever issued was a skeleton key. yikes
